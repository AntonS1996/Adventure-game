...
QT_MOC_LITERAL(1, 7, 10), // "battle_hit"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 5), // "Hero*"
QT_MOC_LITERAL(4, 25, 1), // "h"
QT_MOC_LITERAL(5, 27, 8), // "Monster*"
QT_MOC_LITERAL(6, 36, 1), // "m"
QT_MOC_LITERAL(7, 38, 6), // "damage"
QT_MOC_LITERAL(8, 45, 1), // "i"
QT_MOC_LITERAL(9, 47, 8), // "heroDead"
QT_MOC_LITERAL(10, 56, 11), // "hero_attack"
QT_MOC_LITERAL(11, 68, 14) // "monster_attack"

    },
    "Battle\0battle_hit\0\0Hero*\0h\0Monster*\0"
    "m\0damage\0i\0heroDead\0hero_attack\0"
    "monster_attack"
};
...
void Battle::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->battle_hit((*reinterpret_cast< Hero*(*)>(_a[1])),(*reinterpret_cast< Monster*(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3])),(*reinterpret_cast< int(*)>(_a[4]))); break;
        case 1: _t->heroDead(); break;
        case 2: _t->hero_attack(); break;
        case 3: _t->monster_attack(); break;
        default: ;
        }
        ...
        {
            typedef void (Battle::*_t)(Hero * , Monster * , int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Battle::battle_hit)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Battle::heroDead)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Battle::battle_hit(Hero * _t1, Monster * _t2, int _t3, int _t4)
{
