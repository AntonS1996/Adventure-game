...
QT_MOC_LITERAL(1, 8, 11), // "monsterDead"
QT_MOC_LITERAL(2, 20, 0) // ""

    },
    "Monster\0monsterDead\0"
};
...
void Monster::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Monster::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Monster::monsterDead)) {
                *result = 0;
                return;
            }
        }
